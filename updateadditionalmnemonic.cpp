...
void UpdateAdditionalMnemonic::on_pushButton_INPUT_clicked()
{
    ...
    updating_data();
    data_base_action->update_additional_mnemonic(additional_mnemonic_id,additional_mnemonic_name,company_id,
                                                 main_mnemonic_id,derived_unit_id);
...
void UpdateAdditionalMnemonic::search_current_data()
{
    ...
    main_mnemonic_id=data_base_action->id_exist_data("main_mnemonic_id","additional_mnemonics",condition);
    ...
    qDebug()<<"inital_u_id = "<<inital_unit_id;
    condition="unit_id = "+QString::number(inital_unit_id)+"";
    inital_unit_name=data_base_action->find_with_condition("unit_name","units",condition);
    main_mnemonic_name=data_base_action->find_with_condition("main_mnemonic_name","main_mnemonics",condition);
