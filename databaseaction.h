...
public:
    ...
    void insert_additional_mnemonics(const int& id,const QString& name,const int& company_id,const int& main_mnemonic_id);
    void insert_companies (const int& id,const QString& name);
    void insert_conversion_formulas(const int& id,const QString& name);
    void insert_main_mnemonic_units(const int& id,const QString& name,const QString& description,const int& main_mnemonic_id);
    void insert_main_mnemonics(const int& id,const QString& name,const QString& description,const int& sensor_id);
